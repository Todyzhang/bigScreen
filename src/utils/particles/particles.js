...
function launchParticlesJS(canvas_el, params){
  ...
  pJS.update=pJS.fn.particlesDraw;
...
const particlesJS = function(width,height){
  let params={
    particles: {
      color: '#fff',
  ...
  canvas_el.style['z-index']=-1;
  return launchParticlesJS(canvas_el, params);
